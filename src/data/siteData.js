...
export const specialists = [
  {
    ...
    roleTag: 'Odontologia Estética',
    headline: 'Harmonia e proporções naturais do sorriso.',
    specialty: 'Cirurgiã-dentista clínica geral, pós-graduada em estética dental.',
    differential: 'Planejamento digital individualizado, facetas cerâmicas, lentes de contato e clareamento guiado.',
    cro: 'CRO-CE',
    image: assets.team[0],
    featured: false,
  },
  {
    id: 'ismael-lima',
    name: 'Dr. Ismael Lima',
    roleTag: 'Saúde Bucal & Prevenção',
    headline: 'Odontologia humanizada e atendimento sem medo.',
...

  {
    id: 'hugo-mota',
    name: 'Dr. Hugo Mota',
    roleTag: 'Reabilitação Oral',
    headline: 'Segurança mastigatória e precisão cirúrgica.',
    specialty: 'Especialista em implantes e prótese dentária.',
    differential: 'Reabilitação oral para recuperar a estabilidade mastigatória, alinhamento oclusal e a segurança de sorrir.',
    cro: 'CRO-CE',
    image: assets.team[1],
    featured: false,
  },
  {
    id: 'hanna-isa',
    name: 'Dra. Hanna Isa',
    roleTag: 'Ortodontia Contemporânea',
    headline: 'Alinhamento funcional com conforto e discrição.',
    specialty: 'Especialista em ortodontia (aparelhos e alinhadores).',
    differential: 'Correção de oclusão e alinhamento do arco dentário com técnicas modernas e discretas para crianças e adultos.',
    cro: 'CRO-CE',
    image: assets.team[2],
    featured: false,
  },
